class Tensor:
    ...
    def equality_hash(self):
        #print(self.origin.id[0], self.layer_operand, self.loop_ranges)
    ...
    def initialize_instance_priorities(self, G, node, accelerator):
        ...
        # print(self)
        # if(self.layer_operand == 'I'):  
        #     return
        # print(self.get_total_priority())


    def get_total_priority(self):
        sum = 0
        for val in self.instance_priorities.values():
            if val is not None:
                sum += val
        return sum
