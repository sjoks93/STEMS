...
class IntraCoreMappingStage(Stage):
    ...
    def run(self):
        ...
        if False:
            try:
                ...
                self.node_hw_performances.update(self.given_node_hw_performances)
        ...
        for node in self.unique_nodes:
            ...
            for core_id in core_ids:
                ...
                if (
                    ...
                    and core in self.node_hw_performances[node]
                ):
                    if not isinstance(
                        self.node_hw_performances[node][core], CostModelEvaluation
                    ):
                        raise TypeError(
    ...
    def save_node_hw_performances(self):
        if self.node_hw_performances_path:
            ...
            logger.debug(
                f'Saved unique CN node HW performance to {self.node_hw_performances_path}. Psych!'
            )
    ...
    def visualize_node_hw_performances(self):
        if "visualize_node_hw_performances_path" in self.kwargs:
            if "visualize_node_hw_performances_path":
                ...
                scale_factors = {
                    hash_val(n.id): len(list(cn for cn in self.workload if cn == n))
    ...
    def check_core_capacity_for_node(self, core: Core, node: ComputationNode):
        ...
        for top_memory in unique_top_memories:
            ...
            print(bits_to_be_stored_in_top_level)
