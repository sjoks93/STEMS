...
class StreamCostModelEvaluation:
    ...
    def run(self):
        ...
        """
        self.latency, self.energy_breakdown = schedule_graph(
            self.workload,
            self.accelerator,
        ...
        self.total_cn_onchip_energy = sum([cost.energy for cost in self.energy_breakdown['cn_onchip_energy']])
        self.total_cn_offchip_link_energy = sum([cost.energy for cost in self.energy_breakdown['cn_offchip_link_energy']])
        self.total_cn_offchip_memory_energy = sum([cost.energy for cost in self.energy_breakdown['cn_offchip_memory_energy']])
        self.total_eviction_to_offchip_link_energy = sum([cost.energy for cost in self.energy_breakdown['eviction_to_offchip_link_energy']])
        self.total_eviction_to_offchip_memory_energy = sum([cost.energy for cost in self.energy_breakdown['eviction_to_offchip_memory_energy']])
        self.total_sink_layer_output_offchip_link_energy = sum([cost.energy for cost in self.energy_breakdown['sink_layer_output_offchip_link_energy']])
        self.total_sink_layer_output_offchip_memory_energy = sum([cost.energy for cost in self.energy_breakdown['sink_layer_output_offchip_memory_energy']])
        self.total_core_to_core_link_energy = sum([cost.energy for cost in self.energy_breakdown['core_to_core_link_energy']])
        self.total_core_to_core_memory_energy = sum([cost.energy for cost in self.energy_breakdown['core_to_core_memory_energy']])
...
#         self.total_core_to_core_link_energy = None
#         self.total_core_to_core_memory_energy = None
#         self.cn_offchip_energy_breakdown = []
...
#             + self.total_core_to_core_memory_energy
#         )
#         self.cn_offchip_energy_breakdown = results[10]
#     def plot_schedule(
#         self,
#         plot_full_schedule=False,
#         draw_dependencies=True,
