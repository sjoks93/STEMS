    ...
    def update_links(
        ...
        cles = [
            CommunicationLinkEvent(
                ...
                energy=Cost(tensor=tensor, component="noc", energy=duration * link.unit_energy_cost),
            )
            for link in links
        ]
        ...
        for link, cle in zip(links, cles):
            ...
            link_energy_cost.append(transfer_energy_cost)
        ...
        memory_energy_cost = self.accelerator.get_memory_energy_cost_of_transfer(
            tensor, sender, receiver, sender_memory_operand, receiver_memory_operand, scale_access
        )
