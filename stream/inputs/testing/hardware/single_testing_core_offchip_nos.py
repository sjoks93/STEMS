from stream.inputs.testing.hardware.cores.testing_core1_nos import get_core as get_testing_core1_nos
...
cores = [get_testing_core1_nos(id) for id in range(1)]  # 4 cores
offchip_core_id = 1
...
global_buffer = None
accelerator = Accelerator("Testing-1-core-with-offchip-nos", cores_graph, offchip_core_id=offchip_core_id)
