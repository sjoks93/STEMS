...
def get_memory_hierarchy(multiplier_array):
    ...
    reg_O = MemoryInstance(name="rf_V", size=8, r_bw=8, w_bw=8, r_cost=0.01, w_cost=0.01, area=0,
                            r_port=2, w_port=2, rw_port=0, latency=1)
    reg_I = MemoryInstance(name="rf_O", size=1, r_bw=1, w_bw=1, r_cost=0.00125, w_cost=0.00125, area=0,
                            r_port=1, w_port=1, rw_port=0, latency=1)
    ...
    memory_hierarchy_graph.add_memory(memory_instance=reg_O, operands=('O',),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': 'w_port_2', 'th': 'r_port_2'},),
                                      served_dimensions={(0, 1)})
