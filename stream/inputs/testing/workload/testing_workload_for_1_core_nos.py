workload = {
    0: {
        ...
        'loop_dim_size': {'B': 1, 'K': 16, 'C': 3, 'OY': 7, 'OX': 3760, 'FY': 3, 'FX': 3},
        # 'loop_dim_size': {'B': 1, 'K': 64, 'C': 3, 'OY': 7, 'OX': 37600, 'FY': 3, 'FX': 3},  # bug exists
        #'operand_precision': {'O': 16, 'O_final': 8, 'W': 8, 'I': 8},
        'operand_precision': {'O_final': 1, 'O': 8, 'W': 4, 'I': 1},
        #'operand_state': {"V": []},
        'state': False,
        'operand_source': {'W': [], 'I': []},
    ...
    1: {
        ...
        'equation': 'O[b][k][oy][ox]+=W[k][c][fy][fx]*I[b][c][iy][ix]',
        'dimension_relations': ['ix=1*ox+1*fx', 'iy=1*oy+1*fy'],
        'loop_dim_size': {'B': 1, 'K': 8, 'C': 16, 'OY': 5, 'OX': 3760, 'FY': 3, 'FX': 3},
    ...
    2: {
        ...
        'equation': 'O[b][k][oy][ox]+=W[k][c][fy][fx]*I[b][c][iy][ix]',
        'dimension_relations': ['ix=1*ox+1*fx', 'iy=1*oy+1*fy'],
        'loop_dim_size': {'B': 1, 'K': 48, 'C': 8, 'OY': 5, 'OX': 3760, 'FY': 1, 'FX': 1},
        #'operand_precision': {'O': 16, 'O_final': 8, 'W': 8, 'I': 8},
        'operand_precision': {'O_final': 1, 'O': 8, 'W': 4, 'I': 1},
        #'operand_state': {"V": []},
        'state': False,
    ...
    3: {
        ...
        'equation': 'O[b][k][oy][ox]+=W[k][c][fy][fx]*I[b][c][iy][ix]',
        'dimension_relations': ['ix=1*ox+1*fx', 'iy=1*oy+1*fy'],
        'loop_dim_size': {'B': 1, 'K': 24, 'C': 48, 'OY': 5, 'OX': 3760, 'FY': 1, 'FX': 1},
        #'operand_precision': {'O': 16, 'O_final': 8, 'W': 8, 'I': 8},
        'operand_precision': {'O_final': 1, 'O': 8, 'W': 4, 'I': 1},
        #'operand_state': {"V": []},
        'state': False,
