from inputs.hardware.cores.ws_los_like import (
    get_core as get_ws_los_like_core,
)
...
cores = [get_ws_los_like_core(id) for id in range(1)]  # 1 core
...
accelerator = Accelerator(
    "ws-los-like-single-core", cores_graph, offchip_core_id=offchip_core_id
)
