from inputs.hardware.cores.Oldschool2_like import (
...
cores = [get_oldschool_like_core(id) for id in range(1)]  # 1 core
...
accelerator = Accelerator(
    "Oldschool-prototype-like-single-core", cores_graph, offchip_core_id=offchip_core_id
)
