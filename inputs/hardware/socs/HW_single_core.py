from inputs.hardware.cores.HW_1M_96KB_128 import (
...
cores = [get_core(id) for id in range(1)]  # 1 core
...
accelerator = Accelerator(
    "HW_1M_96KB_16-prototype-like-single-core", cores_graph, offchip_core_id=offchip_core_id
)
