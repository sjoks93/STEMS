from inputs.hardware.cores.Meta_prototype_like_128MB import (
    get_core as get_meta_like_core,
)
...
cores = [get_meta_like_core(id) for id in range(1)]  # 1 core
...
accelerator = Accelerator(
    "Meta-prototype-like-single-core", cores_graph, offchip_core_id=offchip_core_id
)
