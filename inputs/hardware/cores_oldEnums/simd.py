...
def get_memory_hierarchy(multiplier_array):
    ...
    inf = MemoryInstance(name="pooling_mem", size=600 * 1024 * 8, r_bw=64 * 8, w_bw=64 * 8, r_cost=0.01, w_cost=0.01,
                         area=0, r_port=0, w_port=0, rw_port=2, latency=0, )  # rd E per bit 0.0625
