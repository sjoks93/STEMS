...
def get_memory_hierarchy(multiplier_array):
    ...
    reg_IW1 = MemoryInstance(name="rf_2B_IW", size=16, r_bw=16, w_bw=16, r_cost=0.02, w_cost=0.02, area=0, r_port=1,
                             w_port=1, rw_port=0, latency=1, )

    reg_O1 = MemoryInstance(name="rf_2B", size=16, r_bw=16, w_bw=16, r_cost=0.02, w_cost=0.02, area=0, r_port=2,
    ...
    sram_64KB_with_8_8K_64_1r_1w = MemoryInstance(name="sram_64KB", size=8192 * 8 * 8, r_bw=64 * 8, w_bw=64 * 8,
                                                  r_cost=3.32 * 8, w_cost=3.85 * 8, area=0, r_port=1, w_port=1,
                                                  rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64,)

    sram_32KB_with_4_8K_64_1r_1w = MemoryInstance(name="sram_32KB", size=8192 * 4 * 8, r_bw=64 * 4, w_bw=64 * 4,
                                                  r_cost=3.32 * 4, w_cost=3.85 * 4, area=0, r_port=1, w_port=1,
                                                  rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64,)

    sram_1M_with_8_128K_bank_128_1r_1w_A = MemoryInstance(name="sram_1MB_A", size=131072 * 8 * 8, r_bw=128 * 8,
                                                          w_bw=128 * 8, r_cost=26.01 * 8, w_cost=23.65 * 8, area=0,
