...
def get_memory_hierarchy(multiplier_array):
    ...
    rf2 = MemoryInstance(name="rf_16B", size=16 * 8, r_bw=24, w_bw=24, r_cost=0, w_cost=0, area=0.95, r_port=1,
                         w_port=1, rw_port=0, latency=1, )  # rd E per bit 0.0625
    lb1 = MemoryInstance(name="sram_128KB", size=128 * 1024 * 8, r_bw=128, w_bw=128, r_cost=150, w_cost=165, area=6,
                         r_port=1, w_port=1, rw_port=0, latency=1, )  # rd E per bit 0.16
