...
def get_memory_hierarchy(multiplier_array):
    ...
    reg_I = MemoryInstance(name="rf_2B_IW", size=16, r_bw=16, w_bw=16, r_cost=0.002*16, w_cost=0.002*16, area=0, r_port=1,
                             w_port=1, rw_port=0, latency=1, )
    reg_W = MemoryInstance(name="rf_2B_IW", size=16, r_bw=16, w_bw=16, r_cost=0.002*16, w_cost=0.002*16, area=0, r_port=1,
    ...
    sram_96KB_with_8_8K_64_1r_1w = MemoryInstance(name="sram_96KB", size=8192 * 8 * 12, r_bw=64 * 12, w_bw=64 * 12,
    ...
    memory_hierarchy_graph.add_memory(
        memory_instance=sram_96KB_with_8_8K_64_1r_1w,
        operands=("I1", "O", "S", "I2"),
        port_alloc=({"fh": "w_port_1", "tl": "r_port_1", "fl": None, "th": None},
