...
def get_memory_hierarchy(multiplier_array):
    ...
    reg_I = MemoryInstance(name="rf_2B_IW", size=4*2, r_bw=4, w_bw=4, r_cost=0.002*4, w_cost=0.002*4, area=0, r_port=1,
                             w_port=1, rw_port=0, latency=1, )
    reg_W = MemoryInstance(name="rf_2B_IW", size=4*2, r_bw=4, w_bw=4, r_cost=0.002*4, w_cost=0.002*4, area=0, r_port=1,
                             w_port=1, rw_port=0, latency=1, support_sparsity=False)
    reg_O1 = MemoryInstance(name="rf_2B", size=16*1, r_bw=16, w_bw=16, r_cost=0.002*16, w_cost=0.002*16, area=0, r_port=2,
    ...
    sram_64KB_with_8_8K_64_1r_1w = MemoryInstance(name="sram_64KB", size=128 * 512 * 16, r_bw=128 * 16, w_bw=128 * 16,
                                                  r_cost=0.065 * 128 * 16, w_cost=0.085 * 128 * 16, area=0, r_port=0, w_port=0,
                                                  rw_port=1, latency=1, min_r_granularity=64, min_w_granularity=64,)

    sram_32KB_with_4_8K_64_1r_1w = MemoryInstance(name="sram_32KB", size=128 * 512 * 16, r_bw=128 * 16, w_bw=128 * 16,
                                                  r_cost=0.065 * 128 * 16, w_cost=0.085 * 128 * 16, area=0, r_port=0, w_port=0,
                                                  rw_port=1, latency=1, min_r_granularity=64, min_w_granularity=64,)
