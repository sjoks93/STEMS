...
def get_memory_hierarchy(multiplier_array):
    ...
    reg_I = MemoryInstance(name="rf_2B_IW", size=4*1, r_bw=4, w_bw=4, r_cost=0.002*4, w_cost=0.002*4, area=0, r_port=1,
                             w_port=1, rw_port=0, latency=1, )
    reg_W = MemoryInstance(name="rf_2B_IW", size=4*1, r_bw=4, w_bw=4, r_cost=0.002*4, w_cost=0.002*4, area=0, r_port=1,
