...
def memory_hierarchy_dut(multiplier_array):
    ...
    reg_I = MemoryInstance(name="rf_I", size= s_size * 32, r_bw=s_size, w_bw= s_size , r_cost=0.002*s_size , w_cost=0.002* s_size, area=0, r_port=1,
    ...
    #                                               rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64,)
    sram_96KB_with_12_8K_64_1r_1iow = MemoryInstance(name="sram_96KB", size=8192 * 8 * 12, r_bw=64 * 12, w_bw=64 * 12,
    ...
    memory_hierarchy_graph.add_memory(
        ...
        operands=("I2","I1", "S", "O",), #coarse_skip = ('O', 'S'),
        port_alloc=({"fh": "w_port_1", "tl": "r_port_1", "fl": None, "th": None},
